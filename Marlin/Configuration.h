...
#define STRING_CONFIG_H_AUTHOR "(3Deer)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3Deer Mk300"
...
#define Z_CLEARANCE_MULTI_PROBE     2 // 1.5 Z Clearance between multiple probes
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 45  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 21  // Y point for Z homing
#endif
